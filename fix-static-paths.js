...
console.log('🔧 Fixing static file paths for Vercel...\n');
...
htmlFiles.forEach(file => {
  ...
  try {
    ...
    if (content.includes('src="/chat-support.js"')) {
...
console.log('🚀 All chat-support.js paths updated to use absolute paths for Vercel!');
